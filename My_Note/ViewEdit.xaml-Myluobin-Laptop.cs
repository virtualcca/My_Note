...
namespace My_Note
{
    public partial class ViewEdit : PhoneApplicationPage
    {
        ...
        {
            My_Note.Other.StaticMethod.AddOrUpdata("state", "");
            My_Note.Other.StaticMethod.AddOrUpdata("filename", "");
            My_Note.Other.StaticMethod.AddOrUpdata("title", "");
            My_Note.Other.StaticMethod.AddOrUpdata("value", "");
            NavigateToMainPage();
        }
